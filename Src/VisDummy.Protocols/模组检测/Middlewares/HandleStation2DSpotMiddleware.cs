...
{
    public class HandleStation2DSpotMiddleware(模组检测Flusher flusher, IVisProc visproc, IVisParams visParams, ILogger<HandlePlcRequestMiddlewareBase<DevMsg_2DSpotStation, MstMsg_2DSpotStation, SpotStationArgs, SpotStationOkWarp, SpotStationErrWarp>> logger, IMediator mediator) : HandlePlcRequestMiddlewareBase<
