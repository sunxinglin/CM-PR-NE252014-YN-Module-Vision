...
namespace VisDummy.Protocols.水冷板抓取.Middlewares.Common
{
        ...
        HandleIncomingRequestMiddlewareBase<DevMsg, MstMsg, ScanContext, PlcScanner, TIncoming, TPending, TArgs, TOk, TErr>
    {
        ...
        protected HandlePlcRequestMiddlewareBase(PlcCtrlFlusher flusher, ILogger<HandlePlcRequestMiddlewareBase<TIncoming, TPending, TArgs, TOk, TErr>> logger, IMediator mediator) : base(flusher, logger)
        {
            _mediator = mediator;
        }
