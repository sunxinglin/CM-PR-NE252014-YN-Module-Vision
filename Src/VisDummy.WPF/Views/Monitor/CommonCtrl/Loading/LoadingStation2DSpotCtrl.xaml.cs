...
{
    /// <summary>
    /// LoadingStation2DSpotCtrl.xaml 的交互逻辑
    /// </summary>
    public partial class LoadingStation2DSpotCtrl : UserControl, INotifyPropertyChanged
    {
        public LoadingStation2DSpotCtrl()
        {
            InitializeComponent();
        }
        ...
        public static readonly DependencyProperty DevMsgProperty =
            DependencyProperty.Register("DevMsg", typeof(DevMsg_2DSpotStation), typeof(LoadingStation2DSpotCtrl), new PropertyMetadata(null, DevMsgCallBack));
        ...
        {
            if (d is LoadingStation2DSpotCtrl ctrl)
            {
        ...
        public static readonly DependencyProperty MstMsgProperty =
            DependencyProperty.Register("MstMsg", typeof(MstMsg_2DSpotStation), typeof(LoadingStation2DSpotCtrl), new PropertyMetadata(null, MstMsgCallBack));
