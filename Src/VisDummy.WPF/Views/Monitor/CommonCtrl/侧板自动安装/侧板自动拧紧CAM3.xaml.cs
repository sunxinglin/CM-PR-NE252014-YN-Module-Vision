...
{
	/// <summary>
	/// 侧板自动拧紧CAM3.xaml 的交互逻辑
	/// </summary>
	public partial class 侧板自动拧紧CAM3 : UserControl, INotifyPropertyChanged
	{
		public 侧板自动拧紧CAM3()
		{
			InitializeComponent();
		...
		public DevMsg_CAM3 DevMsg
		{
			get { return (DevMsg_CAM3)GetValue(DevMsgProperty); }
		...
		public static readonly DependencyProperty DevMsgProperty =
			DependencyProperty.Register("DevMsg", typeof(DevMsg_CAM3), typeof(侧板自动拧紧CAM3), new PropertyMetadata(null, DevMsgCallBack));
		...
		public MstMsg_CAM3 MstMsg
		{
			get { return (MstMsg_CAM3)GetValue(MstMsgProperty); }
		...
		public static readonly DependencyProperty MstMsgProperty =
			DependencyProperty.Register("MstMsg", typeof(MstMsg_CAM3), typeof(侧板自动拧紧CAM3), new PropertyMetadata(null, MstMsgCallBack));
