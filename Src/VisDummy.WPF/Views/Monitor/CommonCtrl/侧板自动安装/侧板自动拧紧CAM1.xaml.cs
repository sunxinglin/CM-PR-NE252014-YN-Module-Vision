...
{
	/// <summary>
	/// 侧板自动拧紧CAM1.xaml 的交互逻辑
	/// </summary>
	public partial class 侧板自动拧紧CAM1 : UserControl, INotifyPropertyChanged
	{
		public 侧板自动拧紧CAM1()
		{
			InitializeComponent();
		...
		public DevMsg_CAM1 DevMsg
		{
			get { return (DevMsg_CAM1)GetValue(DevMsgProperty); }
		...
		public static readonly DependencyProperty DevMsgProperty =
			DependencyProperty.Register("DevMsg", typeof(DevMsg_CAM1), typeof(侧板自动拧紧CAM1), new PropertyMetadata(null, DevMsgCallBack));
		...
		public MstMsg_CAM1 MstMsg
		{
			get { return (MstMsg_CAM1)GetValue(MstMsgProperty); }
		...
		public static readonly DependencyProperty MstMsgProperty =
			DependencyProperty.Register("MstMsg", typeof(MstMsg_CAM1), typeof(侧板自动拧紧CAM1), new PropertyMetadata(null, MstMsgCallBack));
