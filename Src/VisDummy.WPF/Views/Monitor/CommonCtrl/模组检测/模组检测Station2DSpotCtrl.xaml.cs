...
{
    /// <summary>
    /// 模组检测Station2DSpotCtrl.xaml 的交互逻辑
    /// </summary>
    public partial class 模组检测Station2DSpotCtrl : UserControl, INotifyPropertyChanged
    {
        public 模组检测Station2DSpotCtrl()
        {
            InitializeComponent();
        }
        ...
        public static readonly DependencyProperty DevMsgProperty =
            DependencyProperty.Register("DevMsg", typeof(DevMsg_2DSpotStation), typeof(模组检测Station2DSpotCtrl), new PropertyMetadata(null, DevMsgCallBack));
        ...
        {
            if (d is 模组检测Station2DSpotCtrl ctrl)
            {
        ...
        public static readonly DependencyProperty MstMsgProperty =
            DependencyProperty.Register("MstMsg", typeof(MstMsg_2DSpotStation), typeof(模组检测Station2DSpotCtrl), new PropertyMetadata(null, MstMsgCallBack));
